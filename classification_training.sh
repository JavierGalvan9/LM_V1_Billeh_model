...
# do
#     run -g 1 -c 4 -m 80 -t 1:00 -o Out/test_$mnist_noise_std.out -e Error/test_$mnist_noise_std.err -j test_$mnist_noise_std "python classification_training.py --noconnected_areas --mnist_noise_std $mnist_noise_std --test_only --ckpt_dir '/home/jgalvan/Desktop/Neurocoding/LM_V1_Billeh_model/Simulation_results/v1_100000_lm_30000/b_86qi_mnist' --restore_from '/home/jgalvan/Desktop/Neurocoding/LM_V1_Billeh_model/Simulation_results/v1_100000_lm_30000/b_86qi_mnist/Best_model' --seq_len 200 --dtype 'float16' --core_loss --v1_neurons 100000 --lm_neurons 30000 --rate_cost 100 --voltage_cost 1 --recurrent_weight_regularization 0 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm"
# done

python classification_training_testing.py --optimizer 'exp_adam' --learning_rate 0.01 --gradient_checkpointing --restore_from '/home/jgalvan/Desktop/Neurocoding/LM_V1_Billeh_model/Simulation_results/v1_100000_lm_30000/b_07x0_mnist/Intermediate_checkpoints' --recurrent_dampening_factor 0.5 --dampening_factor 0.5 --batch_size $batch_size --dtype 'float16' --n_gpus $num_replicas --core_loss --v1_neurons 100000 --lm_neurons 30000 --osi_cost 20 --rate_cost 100 --voltage_cost 1 --recurrent_weight_regularization 0 --train_noise --train_recurrent_v1 --train_recurrent_lm --train_interarea_lm_v1 --train_interarea_v1_lm --n_runs 2 --n_epochs 10 --steps_per_epoch $steps_per_epoch --val_steps $val_steps

# python classification_training_testing.py --test_only --batch_size $batch_size --dtype 'float16' --n_gpus 1 --core_loss --v1_neurons 100000 --lm_neurons 30000 --val_steps $val_steps
