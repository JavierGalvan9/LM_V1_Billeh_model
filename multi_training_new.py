...
def main(_):
    ...
    with strategy.scope():
        ...
        tf.print(v1_rate_distribution_regularizer, v1_rate_distribution_regularizer2)
        
        # rate_loss = v1_rate_distribution_regularizer(rsnn_layer.output[0][0]) + lm_rate_distribution_regularizer(rsnn_layer.output[0][2]) + v1_rate_distribution_regularizer2(rsnn_layer.output[0][0]) + lm_rate_distribution_regularizer2(rsnn_layer.output[0][2])
        # rate_loss = v1_rate_distribution_regularizer(rsnn_layer.output[0][0]) + v1_rate_distribution_regularizer2(rsnn_layer.output[0][0]) + lm_rate_distribution_regularizer(rsnn_layer.output[0][2]) + lm_rate_distribution_regularizer2(rsnn_layer.output[0][2])
        # rate_loss = lm_rate_distribution_regularizer2(rsnn_layer.output[0][2])
        ...
        with tf.control_dependencies([v1_rate_loss, v1_rate_loss2, lm_rate_loss]):
    ...
    def roll_out(_x, _y, _w, spontaneous=False, trim=True):
        ...
        # v1_recurrent_l2_regularizer = v1_recurrent_regularizer(rsnn_layer.cell.v1.recurrent_weight_values)
        # lm_recurrent_l2_regularizer = lm_recurrent_regularizer(rsnn_layer.cell.lm.recurrent_weight_values)
        # interarea_weights_l2_regularizer = lm_to_v1_weights_l2_regularizer + v1_to_lm_weights_l2_regularizer 
        # recurrent_weights_regularizer = v1_recurrent_l2_regularizer + lm_recurrent_l2_regularizer
