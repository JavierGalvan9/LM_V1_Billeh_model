...
class LGN(object):
    # @profile
    def __init__(self, row_size=120, col_size=240, lgn_data_path=None, n_input=None, dtype=tf.float32):
    ...
    def spatial_response(self, movie, bmtk_compat=True):
        ...
        for i, indices in enumerate(self.spatial_range_indices):
            ...
            convolved_movie = convolved_movie[..., 0]
