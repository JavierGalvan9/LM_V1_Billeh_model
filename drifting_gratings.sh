...
# run -c 1 -m 15 -t 0:30 -o Out/new_or-0_freq-2-L4weight-$E4_weight_factor.out -e Error/new_or-0_freq-2-L4weight-$E4_weight_factor.err "python drifting_gratings.py --V1_neurons 230924 --batch_size 1 --seq_len 3000 --n_simulations 1 --gratings_orientation 0"
