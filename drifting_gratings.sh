...
## E4 weight factor ###
# for E4_weight_factor in 1. 1.25 1.5 1.75 2. 2.5 3.
# do run -c 1 -m 150 -t 40:30 -o Out/or-0_freq-2-L4weight-$E4_weight_factor.out -e Error/or-0_freq-2-L4weight-$E4_weight_factor.err "python drifting_gratings.py --V1_neurons 230924 --batch_size 1 --seq_len 3000 --E4_weight_factor $E4_weight_factor --n_simulations 3"
# # do run -c 1 -m 10 -t 20:30 -o Out/or-"$orientation"_freq-"$frequency".out -e Error/or-"$orientation"_freq-"$frequency".err "python drifting_gratings.py --V1_neurons 2309 --batch_size 1 --seq_len 3000 --gratings_orientation $orientation --gratings_frequency $frequency --n_simulations 2"
# done
