...
python parallel_training_testing.py --core_loss --interarea_weight_distribution 'billeh_weights' --E4_weight_factor 4.0 --v1_neurons 100000 --lm_neurons 30000 --rate_cost 10000 --osi_cost 20 --sync_cost 0.1 --recurrent_weight_regularization 1 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm --n_runs 1 --n_epochs 50 --steps_per_epoch 25
# python parallel_training_testing.py --core_loss --interarea_weight_distribution 'random_weights' --random_weights --E4_weight_factor 4.0 --v1_neurons 100000 --lm_neurons 30000 --rate_cost 10000 --osi_cost 20 --sync_cost 0.1 --recurrent_weight_regularization 1 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm --n_runs 1 --n_epochs 50 --steps_per_epoch 25
