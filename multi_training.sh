...
# run -g 1 -c 4 -m 20 -t 2:00 -o Out/gordo.out -e Error/gordo.err -j gordo "python osi_dsi_estimator.py --seq_len 200 --dtype 'float16' --core_loss --interarea_weight_distribution 'billeh_weights' --E4_weight_factor 4.0 --v1_neurons 100000 --lm_neurons 30000 --ckpt_dir '/home/jgalvan/Desktop/Neurocoding/LM_V1_Billeh_model/Simulation_results/v1_100000_lm_30000/b_p8uy' --restore_from 'Best_model' --run_session 1000 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm"

num_replicas=1
python multi_training_testing.py --n_gpus $num_replicas --batch_size 1 --dtype 'float16' --core_loss --interarea_weight_distribution 'billeh_weights' --E4_weight_factor 4.0 --v1_neurons 230924 --lm_neurons 230924 --rate_cost 10000 --osi_cost 20 --sync_cost 0.0001 --recurrent_weight_regularization 1 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm --n_runs 1 --n_epochs 10 --steps_per_epoch 100
