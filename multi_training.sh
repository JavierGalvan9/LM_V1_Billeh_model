...
num_replicas=2
python multi_training_testing.py --n_gpus $num_replicas --batch_size 4 --dtype 'float16' --core_loss --interarea_weight_distribution 'billeh_weights' --E4_weight_factor 4.0 --v1_neurons 100000 --lm_neurons 30000 --rate_cost 10000 --osi_cost 20 --sync_cost 0.5 --recurrent_weight_regularization 1 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm --n_runs 1 --n_epochs 50 --steps_per_epoch 100
