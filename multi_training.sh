...
python parallel_training_testing.py --core_loss --reset_every_step --interarea_weight_distribution 'billeh_weights' --E4_weight_factor 4.0 --v1_neurons 100000 --lm_neurons 30000 --rate_cost 10000 --osi_cost 10 --sync_cost 1 --recurrent_weight_regularization 1 --train_noise --train_interarea_lm_v1 --train_interarea_v1_lm --train_recurrent_v1 --train_recurrent_lm --n_runs 2 --n_epochs 10 --steps_per_epoch 25
