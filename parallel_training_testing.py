...
def main():                
    ...
    evaluation_commands = ["run", "-g", "1", "-m", "80", "-t", "2:00"]
    ...
    # initial_benchmark_model = '/home/jgalvan/Desktop/Neurocoding/LM_V1_Billeh_model/Simulation_results/v1_90000_lm_30000_E4_weight_factor_4.0/b_c132/OSI_DSI_checkpoints'
